...
public class LineBreakLayout extends ViewGroup {
    ...
    public LineBreakLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LogUtil.e(TAG, "ROW_SPACE="+ROW_SPACE+"   LEFT_RIGHT_SPACE="+LEFT_RIGHT_SPACE);
    }
...
//                            lableSelected.clear();
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            if(childCount<=0){
                ...
                for(int i = 0;i<childCount; i++){
                    ...
                    LogUtil.e(TAG , "标签宽度:"+childW +" 行数："+row+"  剩余宽度："+widthSpace);
                ...
                LogUtil.e(TAG , "总高度:"+height +" 行数："+row+"  标签高度："+childH);
            }
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            LogUtil.d(TAG, "left = " + (right - childW) +" top = " + (botom - childH)+
