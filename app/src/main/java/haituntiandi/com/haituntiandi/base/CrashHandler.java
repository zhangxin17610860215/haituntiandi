...
import haituntiandi.com.haituntiandi.utils.AppManager;
...
//            MobclickAgent.onKillProcess(AppManager.getAppManager().currentActivity());
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                ToastUtil.showMsg("很抱歉,程序出现异常,即将退出");
                Looper.loop();
            }
        }.start();
        //将Crash信息上传到友盟
