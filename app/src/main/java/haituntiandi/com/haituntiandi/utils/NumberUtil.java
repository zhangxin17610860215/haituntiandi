...
public class NumberUtil {
    ...
    public static String get2String(String value) {
        ...
        try {
            ...
            ex.printStackTrace();
            ToastUtil.showMsg("数据不正确："+ value);
            LogUtil.e(NumberUtil.class.getSimpleName(), "get2String(), value="+ value+ ", "+ ex.getMessage());
        }
        return ret;
//        String str = "";
//        //        删除“.”后面超过2位后的数据
...
//        return str;
     ...
     */
    public static String intercept(String value, int newScale){
        String str = "0";
        try {
            ...
            ex.printStackTrace();
            ToastUtil.showMsg("数据不正确："+ value);
            LogUtil.e(NumberUtil.class.getSimpleName(), "intercept(), value="+ value+ ", "+ ex.getMessage());
        }
        return str;
    }
